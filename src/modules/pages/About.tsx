...
export default function About() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <Meta 
        title="About — C¥BRD" 
        description="Born from the alleyways and neon-lit nights. C¥BRD merges utilitarian street silhouettes with a refined cyber aesthetic. Limited-run cyberpunk streetwear." 
        image="/logo.png"
      />
